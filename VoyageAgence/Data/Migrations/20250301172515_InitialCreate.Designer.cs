...
namespace VoyageAgence.Data.Migrations
{
    ...
    [Migration("20250301172515_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Agence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Chauffeur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Flotte", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Offre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Voyage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasDiscriminator<string>("TypeUtilisateur").HasValue("IdentityUser");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Utilisateur", b =>
                {
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Administrateur", b =>
                {
                    b.HasBaseType("AgenceVoyage.Models.Utilisateur");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Gestionnaire", b =>
                {
                    b.HasBaseType("AgenceVoyage.Models.Utilisateur");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Agence", b =>
                {
                    b.HasOne("AgenceVoyage.Models.Gestionnaire", "Gestionnaire")
                        .WithMany("Agences")
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Offre", b =>
                {
                    b.HasOne("AgenceVoyage.Models.Agence", "Agence")
                        .WithMany("Offres")
                        .HasForeignKey("AgenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgenceVoyage.Models.Gestionnaire", null)
                        .WithMany("Offres")
                        .HasForeignKey("GestionnaireId");
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("AgenceVoyage.Models.Voyage", "Voyage")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Voyage", b =>
                {
                    b.HasOne("AgenceVoyage.Models.Chauffeur", "Chauffeur")
                        .WithMany("Voyages")
                        .HasForeignKey("ChauffeurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgenceVoyage.Models.Flotte", "Flotte")
                        .WithMany("Voyages")
            ...
            modelBuilder.Entity("AgenceVoyage.Models.Utilisateur", b =>
                {
                    b.HasOne("AgenceVoyage.Models.Administrateur", null)
